# -*- coding: utf-8 -*-
"""Sentiment Analysis Gnews automation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wp5c8JagV3pf-FVtixKTH-lzbyHXi7i3
"""
...
# Define a function called get_news to pull news from googlenews api
...
# Define a function called get_correlation_coefficient to investigate the relationship between the sentiment scores of news and stock prices
def get_correlation_coefficient(mean_df,df_stock):
    ...
    df_final['Day Change']=df_final['Close Price']-df_final['Close Price Last Day']
    df_final=df_final.dropna()
    r = stats.pearsonr(df_final['compound scores'], df_final['Day Change'])
...
# Display correlation coefficient dataframe of 11 companies
df1

# ETF sentiment analysis for 5 interested ETF
df2=corr_df(['iShares US Healthcare','iShares US Consumer Goods','iShares S&P 500 Growth','ARKK','ARKW'],['IYH','IYK','IVW','ARKK','ARKW'])

# Display correlation coefficient dataframe df2 
df2